...
- **Local deep cuts as a reward layer.** The rotary. Drawbridge-schedule grumbling. NBPT 01950 stickers. Thanksgiving vs. Amesbury trash talk (5th-oldest rivalry in the state). A "famous wrestler from West Newbury" who keeps getting spotted at the waterfront restaurant. None of it explained — locals just *get it*. (NB: only ship deep cuts that are *actually true* — the "Joppa is pronounced JOP-pee" claim was wrong and was cut.)
